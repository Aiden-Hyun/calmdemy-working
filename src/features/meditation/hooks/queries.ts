 ...
 *   a different slice of content (courses, guided meditations, and filtered views
 *   by theme/technique), all implementing the Stale-While-Revalidate pattern for
 *   reliable offline-first content delivery. (Emergency meditations moved to
 *   features/emergency in 6d-4.)
 *
 * Design Patterns:
